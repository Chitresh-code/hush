...
- **DEC-002**: Distribute the client through `npm install -g @anvara/hush`. During private development, validate with `npm pack` or a private registry rather than publishing the package publicly.
