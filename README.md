...
Hush is under active development. Version 0.3.0 adds encrypted local-vault primitives and refines the themed application shell. The CLI does not expose secret storage yet.
